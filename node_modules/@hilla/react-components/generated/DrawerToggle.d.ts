...
export declare const DrawerToggle: (props: WebComponentProps<DrawerToggleElement, Readonly<{}>> & React.RefAttributes<DrawerToggleElement>) => React.ReactElement<any, string | React.JSXElementConstructor<any>> | null;
