...
export declare const HorizontalLayout: (props: WebComponentProps<HorizontalLayoutElement, Readonly<{}>> & React.RefAttributes<HorizontalLayoutElement>) => React.ReactElement<any, string | React.JSXElementConstructor<any>> | null;
