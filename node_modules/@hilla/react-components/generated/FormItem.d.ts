...
export declare const FormItem: (props: WebComponentProps<FormItemElement, Readonly<{}>> & React.RefAttributes<FormItemElement>) => React.ReactElement<any, string | React.JSXElementConstructor<any>> | null;
