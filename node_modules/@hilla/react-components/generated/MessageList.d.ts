...
export declare const MessageList: (props: WebComponentProps<MessageListElement, Readonly<{}>> & React.RefAttributes<MessageListElement>) => React.ReactElement<any, string | React.JSXElementConstructor<any>> | null;
