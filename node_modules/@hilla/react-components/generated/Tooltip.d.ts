...
export declare const Tooltip: (props: WebComponentProps<TooltipElement, Readonly<{}>> & React.RefAttributes<TooltipElement>) => React.ReactElement<any, string | React.JSXElementConstructor<any>> | null;
