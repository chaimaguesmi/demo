...
export declare const FormLayout: (props: WebComponentProps<FormLayoutElement, Readonly<{}>> & React.RefAttributes<FormLayoutElement>) => React.ReactElement<any, string | React.JSXElementConstructor<any>> | null;
