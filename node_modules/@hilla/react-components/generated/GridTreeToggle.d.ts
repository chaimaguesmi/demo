...
export declare const GridTreeToggle: (props: WebComponentProps<GridTreeToggleElement, Readonly<{
    onExpandedChanged: EventName<_GridTreeToggleEventMap["expanded-changed"]>;
}>> & React.RefAttributes<GridTreeToggleElement>) => React.ReactElement<any, string | React.JSXElementConstructor<any>> | null;
