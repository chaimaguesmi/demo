...
export declare const Message: (props: WebComponentProps<MessageElement, Readonly<{}>> & React.RefAttributes<MessageElement>) => React.ReactElement<any, string | React.JSXElementConstructor<any>> | null;
